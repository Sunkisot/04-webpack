  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFViewerApplication = {
      ...
      _readPreferences: function _readPreferences () {
        ...
        var viewerPrefs = this.viewerPrefs
      ...
      load: function load (pdfDocument, scale) {
        ...
        firstPagePromise.then(function (pdfPage) {
          ...
          Promise.all([storePromise, pageModePromise]).then(function (_ref2) {
            ...
            var _ref3$ = _ref3[0]
            var values = _ref3$ === undefined ? {} : _ref3$
            var pageMode = _ref3[1]
            ...
            var hash = _ref4.hash
            var sidebarView = _ref4.sidebarView
      ...
      setInitialView: function setInitialView (storedHash) {
        ...
        var scale = _options$scale === undefined ? 0 : _options$scale
        var _options$sidebarView = options.sidebarView
        var sidebarView = _options$sidebarView === undefined ? _pdf_sidebar.SidebarView.NONE : _options$sidebarView
    ...
    var PDFCursorTools = (function () {
      function PDFCursorTools (_ref) {
        ...
        Promise.all([preferences.get('cursorToolOnLoad'), preferences.get('enableHandToolOnLoad')]).then(function (_ref2) {
          var _ref3 = _slicedToArray(_ref2, 2)
          var cursorToolPref = _ref3[0]
          var handToolPref = _ref3[1]
        ...
        value: function open () {
          ...
          Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(function () {
            ...
            _this.pdfDocument.getMetadata().then(function (_ref2) {
              ...
              var fileSize = _ref4[2]
              var creationDate = _ref4[3]
              var modificationDate = _ref4[4]
